...
export const translations = {
  fr: {
    ...
    mandates: {
      ...
      humanInTheLoopDesc: 'FaceID requis pour chaque paiement (Human-in-the-loop, DSP3/PSR)',
  ...
  en: {
    ...
    mandates: {
      ...
      humanInTheLoopDesc: 'FaceID required for each payment (Human-in-the-loop, PSD3/PSR)',
